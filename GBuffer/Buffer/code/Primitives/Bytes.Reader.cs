...
namespace Gal.Core {
    ...
    public static class BytesReader {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe float ReadFloat(ref byte* bytes) => BitConverter.Int32BitsToSingle(ReadInt32(ref bytes));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe double ReadDouble(ref byte* bytes) => BitConverter.Int64BitsToDouble(ReadInt64(ref bytes));
